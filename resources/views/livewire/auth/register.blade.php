                            ...
                            <flux:fieldset>
                                ...
                                <div class="grid grid-cols-1 gap-6 mt-4">
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                        ...
                                        <flux:input wire:model="datebirth" :label="__('Date of Birth')" type="date"
                        ...
                        <div class="flex flex-col gap-6 animate-in fade-in slide-in-from-right-4 duration-300">
                            <flux:fieldset>
                                ...
                                <div class="grid grid-cols-1 gap-6 mt-4">
                                    ...
                                    <flux:input wire:model="whatsapp" :label="__('WhatsApp Number')" required
                                        placeholder="08xxxxxxxxxx" icon="phone" />
                                ...
                                <div class="space-y-6 mt-4">
                                    <div
                                        ...
                                        <flux:checkbox wire:model.live="tpalama"
                                            :label="__('Have you attended this TPA before? (optional)')" />
                                        ...
                                        @if ($tpalama)
                                            <div
                                                ...
                                                <flux:select wire:model="leveltpa" :label="__('Previous TPA Level')"
                                                    ...
                                                    @foreach ($levelTpaOptions as $level)
                                    ...
                                    <flux:checkbox wire:model="pendampingan"
                                        :label="__('Requires special assistance? (optional)')" />
