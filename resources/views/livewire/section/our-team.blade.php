    ...
    <section id="team">
        <div class="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-6">
            ...
            <div class="mx-auto mb-8 max-w-screen-sm lg:mb-16">
                <flux:badge color="lime" size="sm" class="mb-4 opacity-0" icon="user-circle">Team</flux:badge>

                <h2 class="mb-4 text-5xl tracking-tight font-extrabold text-gray-900 opacity-0">
                    Our Team
                </h2>
