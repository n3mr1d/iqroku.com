                    ...
                    <div class="grid grid-cols-1 md:grid-cols-5 gap-8 md:gap-4">
                        ...
                        <div class="timeline-item group opacity-0">
                            <div class="flex flex-col items-center text-center">
                                <div class="relative mb-6">
                                    <div
                                        class="w-16 h-16 rounded-full bg-gradient-to-br from-green-500 to-green-600 flex items-center justify-center shadow-xl transform transition-all duration-500 group-hover:scale-125 group-hover:rotate-12 z-10 relative">
                                        <svg class="w-8 h-8 text-white" fill="currentColor" viewBox="0 0 20 20">
                                    ...
                                    <div class="absolute inset-0 rounded-full bg-green-400 opacity-30"></div>
                                </div>
                        ...
                        <div class="timeline-item group opacity-0">
                            <div class="flex flex-col items-center text-center">
                                <div class="relative mb-6">
                                    <div
                                        class="w-16 h-16 rounded-full bg-gradient-to-br from-orange-500 to-orange-600 flex items-center justify-center shadow-xl transform transition-all duration-500 group-hover:scale-125 group-hover:rotate-12 z-10 relative">
                                        <svg class="w-8 h-8 text-white" fill="currentColor" viewBox="0 0 20 20">
                                            <path fill-rule="evenodd"
                                    ...
                                    <div class="absolute inset-0 rounded-full bg-orange-400 animate-ping opacity-20">
                                    </div>
                                    <div class="absolute inset-0 rounded-full bg-orange-400 opacity-30"></div>
                                </div>
                        ...
                        <div class="timeline-item group opacity-0">
                            <div class="flex flex-col items-center text-center">
                                <div class="relative mb-6">
                                    <div
                                        class="w-16 h-16 rounded-full bg-gradient-to-br from-purple-500 to-purple-600 flex items-center justify-center shadow-xl transform transition-all duration-500 group-hover:scale-125 group-hover:rotate-12 z-10 relative">
                                        <svg class="w-8 h-8 text-white" fill="currentColor" viewBox="0 0 20 20">
                                            <path
                                    ...
                                    <div class="absolute inset-0 rounded-full bg-purple-400 opacity-30"></div>
                                </div>

                                <div
                                    class="bg-white rounded-2xl p-6 shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 border-2 border-purple-100 group-hover:border-purple-400">
                                    <span
                                        class="inline-block bg-gradient-to-r from-purple-500 to-purple-600 text-white text-xs font-bold px-3 py-1.5 rounded-full mb-3 shadow-md">
                                        Monitoring
                                    </span>
                                    <h3 class="text-base font-bold text-slate-800 mb-2">
                        ...
                        <div class="timeline-item group opacity-0">
                            <div class="flex flex-col items-center text-center">
                                <div class="relative mb-6">
                                    <div
                                        class="w-16 h-16 rounded-full bg-gradient-to-br from-pink-500 to-pink-600 flex items-center justify-center shadow-xl transform transition-all duration-500 group-hover:scale-125 group-hover:rotate-12 z-10 relative">
                                        <svg class="w-8 h-8 text-white" fill="currentColor" viewBox="0 0 20 20">
                                            <path fill-rule="evenodd"
                                    ...
                                    <div class="absolute inset-0 rounded-full bg-pink-400 animate-ping opacity-20">
                                    </div>
                                    <div class="absolute inset-0 rounded-full bg-pink-400 opacity-30"></div>
                                </div>
