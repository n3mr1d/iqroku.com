<div itemscope itemtype="https://schema.org/EducationalOrganization">
    ...
    <section id="about" class="pt-32 pb-20 px-6">
        <div class="max-w-7xl mx-auto">
            <!-- Header -->
            <header class="about-header text-center mb-16 opacity-0">
                <div class="about-badge inline-flex items-center gap-3 mb-6">
                    <flux:badge color="lime" icon="user"> About Us </flux:badge>
                </div>
                <h1 class="about-title text-5xl md:text-7xl font-black text-gray-900 mb-6 tracking-tight" itemprop="name">
                    TPA Abu Dhabi - Qur'an Learning Center
                </h1>
                <meta itemprop="description"
                    content="TPA Abu Dhabi is a weekly Qur'an learning space for Indonesian children living in Abu Dhabi, focusing on Islamic education and character building.">
            </header>
            ...
            <article class="grid md:grid-cols-2 gap-12 items-center">
                ...
                <figure class="relative h-[500px]">
                    <!-- Image 1 -->
                    <div class="about-image absolute top-0 shadow-xl/30 left-0 w-48 h-56 float-animation "
                        style="animation-delay: 0s;">
                        <img src="{{ asset('/source/IMG_2046.JPG') }}"
                            alt="TPA Abu Dhabi students learning Quran together in classroom"
                    ...
                    <div class="about-image absolute shadow-xl/30 top-12 right-0 w-52 h-60 float-animation "
                        ...
                        <img src="{{ asset('/source/IMG_2047.JPG') }}"
                            alt="Indonesian children studying Islamic education at TPA Abu Dhabi"
                            class="w-full h-full object-cover rounded-2xl shadow-2xl" loading="lazy">
                    </div>
                    ...
                    <div class="about-image absolute shadow-xl/30 bottom-20 left-12 w-44 h-52 float-animation opacity-0"
                        ...
                        <img src="{{ asset('/source/IMG_2048.JPG') }}" alt="TPA Abu Dhabi Islamic learning environment"
                            class="w-full h-full object-cover rounded-2xl shadow-2xl" loading="lazy">
                    </div>
                    ...
                    <div class="about-image absolute bottom-0 shadow-xl/30 right-8 w-48 h-56 float-animation opacity-0"
                        ...
                        <img src="{{ asset('/source/IMG_2049.JPG') }}"
                            alt="Teachers and students at TPA Abu Dhabi Quran learning center"
                            class="w-full h-full object-cover rounded-2xl shadow-2xl" loading="lazy">
                    </div>
                </figure>
            </article>
    ...
    <section id="purpose" class="relative overflow-hidden py-16 md:py-24 px-4 sm:px-6">
        ...
        <div class="absolute top-0 right-0 w-72 h-72 md:w-96 md:h-96 bg-purple-200 rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-pulse"
            aria-hidden="true">
        </div>
        ...
        <div class="max-w-7xl mx-auto relative z-10">
            <!-- Section Header -->
            <header class="purpose-header text-center mb-12 md:mb-20 opacity-0">
                ...
                <h2 class="purpose-title text-4xl md:text-6xl font-bold text-gray-900 mb-6 px-4 leading-tight">
                    Vision & <span
            ...
            <div class="space-y-16">
                ...
                <div class="grid lg:grid-cols-2 gap-6 md:gap-10">
                    <!-- Vision Card -->
                    <article class="purpose-card group relative opacity-0 h-full" itemscope
                        itemtype="https://schema.org/Mission">
                        <div class="absolute inset-0 bg-gradient-to-br from-amber-400 to-orange-500 rounded-3xl blur-xl opacity-20 group-hover:opacity-30 transition-opacity"
                            aria-hidden="true">
                        </div>
                        <div
                            ...
                            <div class="flex flex-col sm:flex-row items-center sm:items-start gap-6">
                                <div class="flex-shrink-0">
                                    <div class="purpose-icon w-16 h-16 md:w-20 md:h-20 bg-gradient-to-br from-amber-400 to-orange-500 rounded-2xl flex items-center justify-center shadow-lg float-animation"
                                        aria-hidden="true">
                                        <svg class="w-8 h-8 md:w-10 md:h-10 text-white" fill="none"
                                            stroke="currentColor" viewBox="0 0 24 24" aria-label="Vision icon">
                    ...
                    <article class="purpose-card group relative opacity-0 h-full" itemscope
                        itemtype="https://schema.org/Mission">
                        <div class="absolute inset-0 bg-gradient-to-br from-purple-500 to-blue-600 rounded-3xl blur-xl opacity-20 group-hover:opacity-30 transition-opacity"
                            aria-hidden="true">
                        </div>
                        <div
                            class="relative h-full bg-white rounded-3xl p-8 md:p-10 shadow-xl hover:shadow-2xl transition-all duration-500 border border-gray-100">
                            <div class="flex flex-col sm:flex-row items-center sm:items-start gap-6">
                                <div class="flex-shrink-0">
                                    <div class="purpose-icon w-16 h-16 md:w-20 md:h-20 bg-gradient-to-br from-purple-500 to-blue-600 rounded-2xl flex items-center justify-center shadow-lg float-animation"
                                        ...
                                        <svg class="w-8 h-8 md:w-10 md:h-10 text-white" fill="none"
                                            stroke="currentColor" viewBox="0 0 24 24" aria-label="Mission icon">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <!-- Mission Details Grid - OUTSIDE the cards -->
                <div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
                    <!-- Mission 1: Qur'an Literacy -->
                    <article
                        ...
                        itemscope itemtype="https://schema.org/EducationalOccupationalProgram">
                        <div class="purpose-icon-small w-14 h-14 md:w-16 md:h-16 bg-gradient-to-br from-blue-100 to-blue-200 rounded-xl flex items-center justify-center mb-6 group-hover:from-blue-500 group-hover:to-blue-600 transition-all duration-300"
                            aria-hidden="true">
                            <svg class="w-7 h-7 md:w-8 md:h-8 text-blue-600 group-hover:text-white transition-colors"
                                fill="currentColor" viewBox="0 0 20 20" aria-label="Quran literacy icon">
                                <path
                                    d="M9 4.804A7.968 7.968 0 005.5 4c-1.255 0-2.443.29-3.5.804v10A7.969 7.969 0 015.5 14c1.669 0 3.218.51 4.5 1.385A7.962 7.962 0 0114.5 14c1.255 0 2.443.29 3.5.804v-10A7.968 7.968 0 0014.5 4c-1.255 0-2.443.29-3.5.804V12a1 1 0 11-2 0V4.804z" />
                            </svg>
                        </div>
                        <flux:badge color="sky">Our Mission</flux:badge>
                        <h4 class="text-lg md:text-xl font-bold text-gray-900 mb-3 group-hover:text-blue-600 transition-colors"
                            itemprop="name">
                            Qur'an Literacy
                        </h4>
                    ...
                    <article
                        ...
                        itemscope itemtype="https://schema.org/EducationalOccupationalProgram">
                        <div class="purpose-icon-small w-14 h-14 md:w-16 md:h-16 bg-gradient-to-br from-purple-100 to-purple-200 rounded-xl flex items-center justify-center mb-6 group-hover:from-purple-500 group-hover:to-purple-600 transition-all duration-300"
                            aria-hidden="true">
                            <svg class="w-7 h-7 md:w-8 md:h-8 text-purple-600 group-hover:text-white transition-colors"
                                fill="currentColor" viewBox="0 0 20 20" aria-label="Islamic character icon">
                                <path fill-rule="evenodd"
                                    d="M3.172 5.172a4 4 0 015.656 0L10 6.343l1.172-1.171a4 4 0 115.656 5.656L10 17.657l-6.828-6.829a4 4 0 010-5.656z"
                                    clip-rule="evenodd" />
                            </svg>
                        </div>
                        <flux:badge color="purple">Our Mission</flux:badge>

                        <h4 class="text-lg md:text-xl font-bold text-gray-900 mb-3 group-hover:text-purple-600 transition-colors"
                            itemprop="name">
                            Islamic Character
                        </h4>
                        <p class="text-gray-600 leading-relaxed text-sm" itemprop="description">
                    ...
                    <article
                        ...
                        itemscope itemtype="https://schema.org/EducationalOccupationalProgram">
                        <div class="purpose-icon-small w-14 h-14 md:w-16 md:h-16 bg-gradient-to-br from-green-100 to-green-200 rounded-xl flex items-center justify-center mb-6 group-hover:from-green-500 group-hover:to-green-600 transition-all duration-300"
                            aria-hidden="true">
                            <svg class="w-7 h-7 md:w-8 md:h-8 text-green-600 group-hover:text-white transition-colors"
                                fill="currentColor" viewBox="0 0 20 20" aria-label="Joyful learning icon">
                                <path fill-rule="evenodd"
                                    d="M11.3 1.046A1 1 0 0112 2v5h4a1 1 0 01.82 1.573l-7 10A1 1 0 018 18v-5H4a1 1 0 01-.82-1.573l7-10a1 1 0 011.12-.38z"
                                    clip-rule="evenodd" />
                            </svg>
                        </div>
                        <flux:badge color="green">Our Mission</flux:badge>

                        <h4 class="text-lg md:text-xl font-bold text-gray-900 mb-3 group-hover:text-green-600 transition-colors"
                            itemprop="name">
                            Joyful Learning
                        </h4>
                        <p class="text-gray-600 leading-relaxed text-sm" itemprop="description">
                    ...
                    <article
                        ...
                        itemscope itemtype="https://schema.org/EducationalOccupationalProgram">
                        <div class="purpose-icon-small w-14 h-14 md:w-16 md:h-16 bg-gradient-to-br from-red-100 to-red-200 rounded-xl flex items-center justify-center mb-6 group-hover:from-red-500 group-hover:to-red-600 transition-all duration-300"
                            aria-hidden="true">
                            <svg class="w-7 h-7 md:w-8 md:h-8 text-red-600 group-hover:text-white transition-colors"
                                fill="currentColor" viewBox="0 0 20 20" aria-label="Community icon">
                                <path
                                    d="M13 6a3 3 0 11-6 0 3 3 0 016 0zM18 8a2 2 0 11-4 0 2 2 0 014 0zM14 15a4 4 0 00-8 0v3h8v-3zM6 8a2 2 0 11-4 0 2 2 0 014 0zM16 18v-3a5.972 5.972 0 00-.75-2.906A3.005 3.005 0 0119 15v3h-3zM4.75 12.094A5.973 5.973 0 004 15v3H1v-3a3 3 0 013.75-2.906z" />
                            </svg>
                        </div>
                        <flux:badge color="red">Our Mission</flux:badge>

                        <h4 class="text-lg md:text-xl font-bold text-gray-900 mb-3 group-hover:text-red-600 transition-colors"
                            itemprop="name">
                            Unified Community
                        </h4>
                        <p class="text-gray-600 leading-relaxed text-sm" itemprop="description">
